  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/prodPrincipal10.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod10imagem1.jpg">
              <img class="thumbnail" src="../img/produtos/prod10imagem2.jpg">
              <img class="thumbnail" src="../img/produtos/prod10imagem3.jpg">
        ...
        <div class = "product-content">
            <h2 class = "product-title"> Air Yeezy 1 Blink </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>O Air Yeezy 'Blink' de abril de 2009 é um dos três tênis que deram início à parceria de Kanye West com a Nike. O cano alto combina uma variedade de materiais e texturas na parte superior, com acabamento em preto tonal com um toque de rosa brilhante no forro, trava de renda e estampa 'Yeezy' no laço do calcanhar. Enquanto o vamp apresenta uma construção em camurça suave, a tira do mediopé e o painel do calcanhar são cobertos com uma estampa 'Y' para uma textura atraente.</p>
              <p></p>
            ...
            <div class="size-container">
                ...
                <input type="Hidden" name="Item_Name" value="Air Yeezy 1 Blink">
