  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/prodPrincipal12.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod12imagem1.jpg">
              <img class="thumbnail" src="../img/produtos/prod12imagem2.jpg">
              <img class="thumbnail" src="../img/produtos/prod12imagem3.jpg">
        ...
        <div class = "product-content">
            <h2 class = "product-title"> Air Jordan VI Retro  </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>O Air Jordan IV, um dos modelos mais populares de Air Jordans, foi criado pelo famoso designer da Nike Tinker Hatfield. Foi o segundo modelo Air Jordan que Tinker projetou e o segundo a apresentar Air visível. O Air Jordan IV foi lançado originalmente em 1989 com 4 cores: branco e cinza cimento, branco preto e vermelho, off-white e azul militar e preto e vermelho (Bred). Devido à sua popularidade, o Air Jordan IV viu muitas colaborações inovadoras ao longo de sua história. </p>
              <p></p>
            ...
            <div class="size-container">
                ...
                <input type="Hidden" name="Item_Name" value="Air Jordan VI Retro ">
