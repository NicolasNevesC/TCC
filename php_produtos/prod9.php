  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/prodPrincipal9.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod9imagem1.jpg">
              <img class="thumbnail" src="../img/produtos/prod9imagem2.jpg">
              <img class="thumbnail" src="../img/produtos/prod9imagem3.png">
        ...
        <div class = "product-content">
            <h2 class = "product-title"> Jordan 12 xvll ovo </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>Em 1996, Michael Jordan e o Chicago Bulls tinham acabado de ganhar seu quarto campeonato da NBA. Na temporada seguinte, os Bulls ganhariam seu quinto título, chegando cada vez mais perto de um segundo tricampeonato. Nos pés de MJ, naquele ano estavam os Air Jordan 12s, tênis inspirados em “Rising Sun” de Tinker Hatfield. O Air Jordan 12 também teve alguns dos momentos mais icônicos de Jordan, consolidando-o como um dos maiores jogadores da história da NBA.</p>
              <p></p>
            ...
            <div class="size-container">
                ...
                <input type="Hidden" name="Item_Name" value=" Jordan 12 xvll ovo ">
