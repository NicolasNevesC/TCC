  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/ProdPrincipal1.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod1image1.PNG">
              <img class="thumbnail" src="../img/produtos/prod1image2.PNG">
              <img class="thumbnail" src="../img/produtos/prod1image3.png">
              <img class="thumbnail active" src="../img/produtos/prod1image4.png">
        ...
        <div class = "product-content">
            <h2 class = "product-title">Nike Lebron 10 Elite Peach Jam </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>Colorway que não foi comercializada ao varejo da décima silhueta de Lebron James com a Nike.</p>
              <p></p>
            ...
            <div class="size-container">
                    <h3 class="title">Escolha o Tamanho:</h3>
                ...
                <input type="Hidden" name="Item_Name" value="Nike Lebron 10 Elite Peach Jam">
