  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/prodPrincipal5.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod5imagem1.webp">
              <img class="thumbnail" src="../img/produtos/prod5imagem2.jpg">
              <img class="thumbnail" src="../img/produtos/prod5imagem3.png">
        ...
        <div class = "product-content">
            <h2 class = "product-title"> Air Jordan 5 </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>O Air Jordan 5 Retro 'Shattered Backboard' apresenta uma paleta familiar em uma construção reconstituída. A parte superior combina a construção tradicional de couro branco com malha têxtil na gola, garganta e painel do quarto, substituindo a rede plástica do original. Um Jumpman laranja bordado adorna a língua prateada fosca refletiva. O cano médio é montado em uma entressola de poliuretano laranja, equipada com uma unidade Air-sole visível no calcanhar e acentuada com detalhes de dentes de tubarão prateados. Sob os pés, uma sola translúcida leitosa apresenta um piso de espinha de peixe para ótima aderência.</p>
              <p></p>
