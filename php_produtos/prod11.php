  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/prodPrincipal11.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod11imagem1.jpg">
              <img class="thumbnail" src="../img/produtos/prod11imagem2.jpg">
              <img class="thumbnail" src="../img/produtos/prod11imagem3.jpg">
        ...
        <div class = "product-content">
            <h2 class = "product-title">Jordan 3 Oregon Ducks </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>Quando fez sua estréia em 1985, a Air Jordan, que quebrou as regras, lançou as bases para a mais famosa franquia de calçados do jogo.Na última edição, uma nova combinação de branco, preto e amarelo retoma a cor do último inverno.Possui couro, uma etiqueta de língua Nike Air e o logotipo icônico da Wings.</p>
              <p></p>
            ...
            <div class="size-container">
                ...
                <input type="Hidden" name="Item_Name" value="Jordan 3 Oregon Ducks">
