  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/prodPrincipal6.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod6imagem1.jpg">
              <img class="thumbnail" src="../img/produtos/prod6imagem2.jpg">
              <img class="thumbnail" src="../img/produtos/prod6imagem3.jpg">
        ...
        <div class = "product-content">
            <h2 class = "product-title"> Jordan Nike Air 6 Electric Green </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>O Air Jordan 6 Retro 'Electric Green' apresenta um esquema de cores de dois tons que lembra um Oregon PE colorway visto pela primeira vez online em 2018. A silhueta apresenta uma parte superior em nobuck preto com detalhes contrastantes de verde neon na lingueta e na aba de puxar. A marca bordada do Jumpman chega no calcanhar do tênis. Uma sola de poliuretano fornece um amortecimento leve, realçada com toques verdes adicionais e equipada com uma unidade de sola Air visível. Sob os pés, a sola de borracha semitranslúcida é tratada com um acabamento que brilha no escuro.</p>
              <p></p>
            ...
            <div class="size-container">
                ...
                <input type="Hidden" name="Item_Name" value="Jordan Nike Air 6 Electric Green">
