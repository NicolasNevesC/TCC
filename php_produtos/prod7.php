  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/prodPrincipal7.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod7imagem1.jpg">
              <img class="thumbnail" src="../img/produtos/prod7imagem2.jpg">
              <img class="thumbnail" src="../img/produtos/prod7imagem3.jpg">  
        ...
        <div class = "product-content">
            <h2 class = "product-title">Nike Mag </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>Em 1989 uma cena mexeu com os sonhos de milhares de crianças e adolescentes de todo mundo: um cara que viajava no tempo num DMC12, chegava ao ano de 2015 e recebia um par de tênis bem esquisitão, que tinha como principal característica o sistema de cadarços que se ajustavam automaticamente.</p>
              <p></p>
            ...
            <div class="size-container">
                ...
                <input type="Hidden" name="Item_Name" value="Nike Mag">
