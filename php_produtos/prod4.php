  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/prodPrincipal4.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod4imagem1.webp">
              <img class="thumbnail" src="../img/produtos/prod4imagem2.jpg">
              <img class="thumbnail" src="../img/produtos/prod4imagem3.jpeg">
        ...
        <div class = "product-content">
            <h2 class = "product-title"> Air Jordan 1 Mid University </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>O Air Jordan 1 Mid University  é uma obra de nostalgia, modernizando os elementos distintivos do ícone de 1985 para homenagear o lendário arco de carreira de Michael Jordan. Estreou em agosto de 2019, esta versão 'Obsidian' homenageia a faculdade alma mater de MJ através de uma paleta de blocos de cores inspirada em equipe na parte superior de couro. Notas de marca e swooshes correspondentes desempenham seu papel na homenagem. A entressola com infusão Nike Air e a sola circular de borracha oferecem conforto e tração clássicos.</p>
              <p></p>
            ...
            <div class="size-container">
                ...
                <input type="Hidden" name="Item_Name" value=" Air Jordan 1 Mid university ">
