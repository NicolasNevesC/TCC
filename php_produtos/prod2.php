  ...
  <!-- Descrição dos Produtos-->
    ...
    <form action="../php/manage_cart.php" method="POST">
      ...
      <div id="content-wrapper">
        ...
        <div class="column">
          <img id=featured src="../img/produtos/prodPrincipal2.PNG">
    
          <div id="slide-wrapper" >
            <img id="slideLeft" class="arrow" src="../img/img_teste/arrowleft.png">
    
            <div id="slider">
              <img class="thumbnail active" src="../img/produtos/prod2imagem1.jpg">
              <img class="thumbnail" src="../img/produtos/prod2imagem2.jpg">
              <img class="thumbnail" src="../img/produtos/prod2imagem3.jpg">
        ...
        <div class = "product-content">
            <h2 class = "product-title">AIR JORDAN 12 </h2>
            </div>
            ...
            <div class = "product-detail">
              ...
              <h2>Sobre Tênis: </h2>
              <p>Originalmente lançado em 1997, MJ vestiu o Air Jordan 12 "Bred" durante alguns dos maiores momentos de sua disputa pelo título naquela temporada. Lembra de seu arremesso vencedor no jogo 1 nas finais? Ou seu desempenho de 39 pontos na vitória do jogo 6 que conquistou o campeonato? Está tudo embutido na história desta lendária execução do Air Jordan 12. Completando a parte superior de couro, o bordado da aba do calcanhar traseiro tem uma mensagem definitiva para qualquer um que adote este amado estilo da Jordan Brand: "Qualidade inspirada no melhor jogador de todos os tempos".</p>
              <p></p>
            ...
            <div class="size-container">
                ...
                <input type="Hidden" name="Item_Name" value="Air Jordan 12">
