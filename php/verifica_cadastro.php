<?php
	...
	$sql = "INSERT INTO `banco_cliente`(`nome`,`cpf`,`email`,`celular`,`senha`) 
	...
	window.alert('Cadastro finalizado, faça o login para começar as compras!')
	window.location.href='../html/login.html?fnc=$fnc&ans=$linha';
	</SCRIPT>");
